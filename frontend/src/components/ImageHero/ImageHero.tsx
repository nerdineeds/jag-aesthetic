...
export function ImageHero({
  ...
  return (
    <div className="relative">
      <div className="sm:hidden md:flex mx-auto lg:mb-12 flex-row bg-lightgrey/50 items-center justify-center sm:w-fit xl:w-[1280px] bg-muted rounded-2xl h-[300px] lg:h-[600px] overflow-hidden">
        <StrapiImage
