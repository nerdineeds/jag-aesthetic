...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/provider-upload-local": "4.24.4",
  "@strapi/utils": "4.24.4",
  axios: "1.6.0",
  "byte-size": "7.0.1",
  cropperjs: "1.6.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-_DdyvVPI.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-PX5wklyR.js"));
        return component;
      },
...
//# sourceMappingURL=index-RTOMBe4e.js.map
