...
const ListView$1 = lazy(() => import("./ListView-c0MC3dN8.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-c0MC3dN8.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-ISp0VZk5.mjs.map
