...
const index$1 = require("./index-Ed7RdefI.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-9jV9N3NS.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-9jV9N3NS.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-fNBrcGJN.js.map
