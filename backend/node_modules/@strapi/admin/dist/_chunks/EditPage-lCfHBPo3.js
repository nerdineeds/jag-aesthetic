...
const useWebhooks = require("./useWebhooks-6OJ9l91j.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-V7FGEtDr.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-lCfHBPo3.js.map
