...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = index.useEnterprise(
    ceLinks,
    async () => (await Promise.resolve().then(() => require("./constants-Lon1KEpM.js"))).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-3r2xVrVd.js"));
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-X_3LwO8I.js"));
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-kMxeEB6b.js"));
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-Vht2RooW.js"));
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-Uup4pCaX.js"));
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-L_63O3vG.js"));
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-lCfHBPo3.js")).then((n) => n.EditPage$1);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-usBw5tSy.js"));
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-AdsXzsed.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-x_mHg9Pv.js"));
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditViewPage-5M3Hj4E_.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-RhZIpX0d.js"));
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-UBcgBw6W.js"));
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditView-ewv5Y1ZH.js"));
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = index.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require("./AdminSeatInfo-Ltll91ic.js"))).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-7kQoQzzn.js"))).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-Eoai75Lq.js.map
