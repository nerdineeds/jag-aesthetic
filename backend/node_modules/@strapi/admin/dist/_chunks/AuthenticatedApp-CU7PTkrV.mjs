...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-lHf4NiOP.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.24.4",
  "@strapi/provider-audit-logs-local": "4.24.4",
  "@strapi/types": "4.24.4",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.24.4",
  "@strapi/data-transfer": "4.24.4",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.24.4",
...
const CM = React.lazy(
  () => import("./index-lHf4NiOP.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-RF8KjDsS.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-QnQd0WME.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-TXqxvOHI.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-lHf4NiOP.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-tbh62Zjk.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-WOltVGmv.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-CU7PTkrV.mjs.map
