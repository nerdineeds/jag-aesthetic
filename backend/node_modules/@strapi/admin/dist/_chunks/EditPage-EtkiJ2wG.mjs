...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-lHf4NiOP.mjs";
...
import { u as useWebhooks } from "./useWebhooks-mN71q4xB.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-rKh3NVUt.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-EtkiJ2wG.mjs.map
